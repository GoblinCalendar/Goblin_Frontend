            ...
            <ScrollView contentContainerStyle={styles.friendList} pointerEvents="box-none">
                {friends.map((friend, index) => (
                    <TouchableOpacity
                        ...
                        style={[
                            styles.friendButton,
                            selectedFriends.includes(friend.loginId) ? styles.selectedFriend : styles.unselectedFriend
                        ]}
                        onPress={() => handleFriendSelect(friend)}
                    >
                        <Text style={[
                            styles.friendText,
                            selectedFriends.includes(friend.loginId) ? styles.selectedText : styles.unselectedText
                        ]}>
                            {friend.username}
                        </Text>
                    </TouchableOpacity>
