...
const mockData = [
  ...
  },
  {
    ...
    day: "일요일",
    month: "9월",
    tasks: [{ id: "7", title: "신제품 상세 페이지 제작", dDay: "D-Day" }],
  },
  {
    date: "16",
    day: "수요일",
...
export default function Todo() {
  ...
  const TodoComponent = ({ navigation }) =>
    // 리렌더링 필요 시 dependency 추가하기
    useMemo(() => {
      return (
                  ...
                  <View key={taskIndex} style={styles.taskContainer}>
                    ...
                    <View style={styles.taskTextContainer}>
                      ...
                      <View
                        style={[
                          styles.dDay,
                          getDdayStyle(task.dDay, checkedItems.includes(task.id)),
                        ]}
                      >
  ...
  return <DrawerWrapper screen={TodoComponent} />;
}
